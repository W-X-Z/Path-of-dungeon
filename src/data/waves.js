...
export const RAIDS = [
  ...
  },
  {
    ...
    openGates: 1,
    squads: [
      { gate: 0, at: 0, units: ['rogue', 'rogue', 'rogue'] },
      { gate: 0, at: 6, units: ['knight', 'knight', 'knight'] },
    ],
  ...
  },
  {
    ...
    openGates: 2,
    squads: [
      { gate: 0, at: 0, units: ['knight', 'knight', 'knight', 'knight'] },
      { gate: 1, at: 3, units: ['rogue', 'rogue', 'rogue', 'rogue'] },
      { gate: 0, at: 9, units: ['knight', 'knight'] },
    ],
  ...
  },
  {
    ...
    squads: [
      ...
      { gate: 0, at: 5, units: ['knight', 'knight', 'knight', 'priest'] },
      { gate: 1, at: 1, units: ['rogue', 'rogue', 'rogue'] },
      { gate: 1, at: 9, units: ['knight', 'knight', 'priest'] },
    ],
  ...
  },
  {
    ...
    openGates: 3,
    squads: [
      { gate: 0, at: 0, units: ['knight', 'knight', 'knight', 'priest'] },
      { gate: 1, at: 2, units: ['rogue', 'rogue', 'rogue', 'rogue'] },
      { gate: 2, at: 5, units: ['knight', 'knight', 'knight', 'knight', 'priest'] },
      { gate: 0, at: 11, units: ['rogue', 'rogue', 'knight', 'knight'] },
      { gate: 2, at: 15, units: ['knight', 'priest', 'priest'] },
    ],
